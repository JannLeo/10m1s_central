...
// // static uint8_t app_test_data[2][1] = {
// //     { [0] = 0x00 },  // 第0行：所有字节为0x00
// //     { [0] = 0x01 }   // 第1行：所有字节为0x01
// // };
// static uint8_t app_test_data[2][17] = {
//     { [0 ... 16] = 0x00 },  // 第0行：所有字节为0x00
//     { [0 ... 16] = 0x01 }   // 第1行：所有字节为0x01
// };
...
//     gpio_function_en(TEST_GPIO1);
//     gpio_output_en(TEST_GPIO1);
//     gpio_input_dis(TEST_GPIO1); 
...
//         gpio_set_high_level(TEST_GPIO1);
...
//                 u8  error_res = BLE_SUCCESS;                                   //connect state
//                 connHandle = conn_dev_list[i].conn_handle;
...
//                     // error_res = blc_ll_clear_central_tx_fifo(connHandle);
//                     // if(error_res != BLE_SUCCESS){
//                     //         tlkapi_printf(APP_LOG_EN, "[APP][TEST] blc_ll_clear_central_tx_fifo     connHandle:%04X status:%02X \r\n", connHandle, error_res);
//                     // }
